import { useTheme } from "../context/ThemeContext";import { themeFocusClasses } from '../utils/styles';
      ...
      <div className={`flex flex-col gap-6 rounded-xl p-6 ${backgroundClass}`}>
        <div className="flex flex-wrap items-center justify-between gap-4">
          ...
          <a
            ...
            download
            className={`rounded-full px-4 py-2 text-sm font-medium transition-colors ${themeFocusClasses(isDark)} ${buttonClass}`}
          >
